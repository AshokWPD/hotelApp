...
class AdminsTicket extends StatelessWidget {
...
final String vendorID;
  ...
  AdminsTicket({super.key,required this.username, required this.uid, required this.vendorID, required this.title});
        ...
        child: Padding(
          ...
          child: Form(
            ...
            final TicketModel ticketmodel=TicketModel(
              ...
              status: "Ticket", 
              replyMessage: "", 
              isAdmin: true, vendorId: vendorID);
...
//   ElectricalContactForm({super.key, required this.title, required this.propertID, required this.username, required this.uid, required this.vendorID});
...
//     return Scaffold(
//         appBar: AppBar(
//             title: const Text('Admin Contact Form'),
//             centerTitle: true,
//           backgroundColor:  Colors.white,
//             ),
//       body: SingleChildScrollView(
